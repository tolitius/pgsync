...
ELASTICSEARCH_SCAN_MAX_RETRIES = env.int("ELASTICSEARCH_SCAN_MAX_RETRIES", default=5)
ELASTICSEARCH_SCAN_RETRY_DELAY_SECONDS = env.int("ELASTICSEARCH_SCAN_RETRY_DELAY_SECONDS", default=3)
